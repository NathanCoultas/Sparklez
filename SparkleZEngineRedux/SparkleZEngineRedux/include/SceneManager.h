...
/*
Scene Manager, handles the scene and the gameobjects involved in that scene.
*/
...
namespace sparklezEngine
{
  ...
  public:
    ...
    static void RemoveLightFromScene(std::weak_ptr<GameObject> _GameObj);
    ...
    static std::vector<std::weak_ptr<GameObject>> &GetSceneLights();
  ...
  private:
    ...
    static std::vector<std::weak_ptr<GameObject>> m_SceneLights;
